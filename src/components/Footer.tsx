...
const Footer = () => {
  ...
  const footerSections = {
    services: [
      ...
      { name: "AI & Machine Learning", href: "/services/artificial-intelligence" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-xl font-bold text-gray-900">MVP Development</span>
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed text-sm max-w-md">
                We help startups and enterprises build successful minimum viable products 
                that validate ideas, attract users, and secure funding through innovative 
        ...
        <div className="py-6 border-t border-stone-100">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
              <p className="text-sm text-gray-600">
                © {currentYear} MVP Development. All rights reserved.
              </p>
              <div className="flex items-center space-x-4">
                ...
                <Link href="/legal/cookies" className="text-xs text-gray-500 hover:text-gray-700 transition-colors duration-200">
                  Cookies
                </Link>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <span className="text-xs text-gray-500">by MVP Development Team</span>
            </div>
          </div>
        </div>
      </div>
