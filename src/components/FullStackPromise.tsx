        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Working with MVP Development means comprehensive solutions, seamless integration, and scalable architecture. Better development partnership, really!
            </p>
            ...
            <div className="mb-8">
              ...
              <blockquote className="text-xl text-gray-700 leading-relaxed">
                Thanks to their full-stack expertise, <span className="font-semibold text-gray-900">our entire platform is unified</span>—frontend, backend, and mobile all work perfectly together.
              </blockquote>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-gray-600 text-sm">CTO @ DataFlow Solutions</div>
              </div>
            </div>
          </div>
        </div>
...
export default FullStackPromise; 