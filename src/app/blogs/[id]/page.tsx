  ...
  const relatedPosts = [
    {
      ...
      image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=300&h=180&fit=crop&crop=smart",
      category: "Blockchain",
      readTime: "8 min read"
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=300&h=180&fit=crop&crop=smart",
      category: "Business",
      readTime: "6 min read"
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=300&h=180&fit=crop&crop=smart",
        ...
        <header className="mb-8">
          ...
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">AI & MVP Development Specialist</p>
            </div>
          </div>
        </header>
      ...
      <section className="bg-neutral-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-light text-gray-900 mb-4">Related Articles</h2>
            <p className="text-gray-600">Explore more insights on MVP development and technology</p>
          </div>
